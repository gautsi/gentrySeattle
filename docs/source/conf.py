# -*- coding: utf-8 -*-
#
# Gentrification in Seattle documentation build configuration file, created by
...
MOCK_MODULES = ['scipy', 'matplotlib', 'matplotlib.pyplot', 'matplotlib.colors', 'sklearn.neighbors', 'pandas', 'sqlalchemy', 'mpl_toolkits.basemap']
...
intersphinx_mapping = {'http://docs.python.org/': None, 'http://scikit-learn.org/stable/' : None, 'http://docs.sqlalchemy.org/en/rel_0_9/' : None, 'http://pandas.pydata.org/pandas-docs/stable/' : None}
